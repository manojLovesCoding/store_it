  ...
  return (
    <div className="mx-auto grid max-w-7xl grid-cols-1 gap-6 md:grid-cols-2 xl:gap-10 !important">
          ...
          {usageSummary.map((summary) => (
            ...
            >
              <div className="space-y-4">
                ...
                <h5 className=" text-[16px] leading-[24px] font-semibold relative z-20 text-center !important">
                  {summary.title}
                </h5>
      ...
      <section className="h-full rounded-[20px] bg-white p-5 xl:p-8 !important">
        <h2 className="text-[20px] leading-[28px] font-semibold xl:text-[24px] xl:leading-[36px] xl:font-bold text-light-100">
          Recent files uploaded
        </h2>
              ...
              >
                ...
                <div className="flex w-full flex-col xl:flex-row xl:justify-between !important">
                  <div className="flex flex-col gap-1">
                    <p className="text-[14px] leading-[20px] font-semibold line-clamp-1 w-full text-light-100 sm:max-w-[200px] lg:max-w-[250px] !important">
                      {file.name}
                    </p>
                    <FormattedDateTime
                      date={file.$createdAt}
