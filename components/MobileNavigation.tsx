  ...
  return (
    <header className="flex h-[60px] justify-between px-5 sm:hidden !important">
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        ...
        <SheetContent className="pt-0 h-screen px-3 !important">
          <SheetTitle>
          ...
          <nav className="text-[16px] leading-[24px] font-semibold flex-1 gap-1 text-brand !important">
                ...
                <Link key={name} href={url} className="lg:w-full">
                  <li
                    className={cn(
                      ...
                      pathname === url &&
                        "bg-brand text-white shadow-drop-2 !important"
                    )}
                  >
                    <Image
                      src={icon}
          ...
          <div className="flex flex-col justify-between gap-5 pb-5">
            ...
            <Button
              type="submit"
              className="text-[16px] leading-[24px] font-semibold flex h-[52px] w-full items-center gap-4 rounded-full bg-brand/10 px-6 text-brand shadow-none transition-all hover:bg-brand/20 !important"
              onClick={() => {}}
            >
              <Image
