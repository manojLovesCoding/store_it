...
const DetailRow = ({ label, value }: { label: string; value: string }) => (
  <div className="flex">
    <p className="text-[14px] leading-[20px] font-normal w-[30%] text-light-100 !important text-left">
      {label}
    </p>
    <p className="text-[14px] leading-[20px] font-semibold flex-1 !important text-left">
      {value}
    </p>
  </div>
);
