      ...
      <AlertDialogContent className="space-y-4 max-w-[95%] sm:w-fit rounded-xl md:rounded-[30px] px-4 md:px-8 py-10 bg-white outline-none !important">
        ...
        <InputOTP maxLength={6} value={password} onChange={setPassword}>
          <InputOTPGroup className="w-full flex gap-1 sm:gap-2 justify-between !important">
            <InputOTPSlot
              index={0}
              className="text-[40px] font-medium rounded-xl ring-brand shadow-drop-1 text-brand-100 justify-center flex border-2 border-light-300 size-12 md:size-16 gap-5 !important"
            />
            <InputOTPSlot
              index={1}
              className="text-[40px] font-medium rounded-xl ring-brand shadow-drop-1 text-brand-100 justify-center flex border-2 border-light-300 size-12 md:size-16 gap-5 !important"
        ...
        <AlertDialogFooter>
          <div className="flex w-full flex-col gap-4">
            <AlertDialogAction
              ...
              className="bg-brand text-[14px] leading-[20px] font-medium hover:bg-brand-100 transition-all rounded-full !important h-12"
              type="button"
            >
              Submit
              {isLoading && (
