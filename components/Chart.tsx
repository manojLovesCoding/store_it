...
export const Chart = ({ used = 0 }: { used: number }) => {
  ...
  return (
    <Card className="flex items-center rounded-[20px] bg-brand p-5 text-white md:flex-col xl:flex-row !important">
      <CardContent className="flex-1 p-0">
        <ChartContainer
          config={chartConfig}
          className="mx-auto aspect-square w-[180px] text-white xl:w-[250px] !important"
        >
          <RadialBarChart
            data={chartData}
            startAngle={90}
          ...
          >
            <PolarGrid
              ...
              radialLines={false}
              stroke="none"
              className="first:fill-white/20 last:fill-brand !important"
              polarRadius={[86, 74]}
            />
      ...
      <CardHeader className="flex-1 items-start px-3 py-0 sm:px-5 lg:p-3 xl:pr-5 !important">
        <CardTitle className="text-[20px] leading-[28px] font-bold md:text-center lg:text-left !important">
          Available Storage
        </CardTitle>
